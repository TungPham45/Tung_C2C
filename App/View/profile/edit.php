...
<body>
    <div class="auth-container wide">
        ...
        <form action="/quanlyc2c/Public/profile/edit" method="POST" enctype="multipart/form-data">
            
            <div style="text-align: center; margin-bottom: 20px;">
                <label>Ảnh đại diện hiện tại</label><br>
                <?php 
                    $avatarPath = $user['anhdaidien'] ? '/quanlyc2c/Public/Uploads/Avatars/' . $user['anhdaidien'] : '/quanlyc2c/Public/Uploads/Avatars/default.png';
                ?>
            ...
            <div style="display: flex; gap: 15px;">
                <a href="/quanlyc2c/Public/profile/show" class="btn" style="background: #858796; text-decoration: none; text-align: center;">Hủy</a>
