    ...
    <div class="auth-container wide profile-card">
        <div style="text-align: center; margin-bottom: 30px; border-bottom: 1px solid #eee; padding-bottom: 20px;">
            <div style="position: relative; display: inline-block;">
                <?php 
                    $avatarPath = !empty($user['anhdaidien']) 
                        ? '/quanlyc2c/Public/Uploads/Avatars/' . $user['anhdaidien'] 
                        : '/quanlyc2c/Public/Uploads/Avatars/default.png'; // Bạn nên có 1 file ảnh mặc định
                ?>
        ...
        <div class="info-row">
            ...
            <span class="info-value"><?php echo $user['tentaikhoan']; ?></span>
        </div>
        <div class="info-row">
        ...
        <div style="margin-top: 30px; display: flex; gap: 15px;">
            <a href="/quanlyc2c/Public/home/index" class="btn" style="background: #858796; text-decoration: none; text-align: center; flex: 1;">
                <i class="fas fa-arrow-left"></i> Quay lại
            </a>
            <a href="/quanlyc2c/Public/profile/edit" class="btn" style="text-decoration: none; text-align: center; flex: 1;">
